...
static inline int8_t FStar_Int8_shift_arithmetic_right(int8_t a, uint32_t b) {
  do {
    KRML_HOST_EPRINTF(
...
static inline int16_t FStar_Int16_shift_arithmetic_right(int16_t a,
                                                         uint32_t b) {
  do {
    KRML_HOST_EPRINTF(
        "Could not identify compiler so could not provide an implementation of "
...
static inline int32_t FStar_Int32_shift_arithmetic_right(int32_t a,
                                                         uint32_t b) {
  do {
    KRML_HOST_EPRINTF(
        "Could not identify compiler so could not provide an implementation of "
...
static inline int64_t FStar_Int64_shift_arithmetic_right(int64_t a,
                                                         uint32_t b) {
  do {
    KRML_HOST_EPRINTF(
        "Could not identify compiler so could not provide an implementation of "
